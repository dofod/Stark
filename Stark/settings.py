...
DATABASES = {
    'default': {
        ...
        'NAME': 'stark.sqlite',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'stark',
        'PASSWORD': 'lannister',
        'HOST': '192.168.1.100',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
SECRET_KEY = '5)g34c#ji25izdo9pet%wpjumobjd+d+-jf$+0*ve575%rp*z!'
...
MIDDLEWARE_CLASSES = (
    ...
    'Common.django-crossdomainxhr-middleware.XsSharing',
